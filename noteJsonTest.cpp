...
#ifdef BOOST_PT_JSON
BOOST_AUTO_TEST_CASE(s_noteJson_c_Test)
{
    BOOST_TEST_MESSAGE("s_noteJson_c_Test");
    noteJson note;
}
BOOST_AUTO_TEST_CASE(s_noteJson_with_ss_Test)
{
    BOOST_TEST_MESSAGE("s_noteJson_with_ss_Test");
...
{
    BOOST_TEST_MESSAGE("s_noteJson_put_Test");
    std::stringstream d("{\"id\":\"1\",\"body\":\"test1\"}");
    noteJson note;
    note.put(d);
    std::string id = note.getId();
...
{
    BOOST_TEST_MESSAGE("s_noteJson_put2_Test");
    std::string f("id");
    std::string s("1");
...
{
    BOOST_TEST_MESSAGE("s_noteJson_tooutstream_Test");
    std::stringstream d("{\"id\":\"1\",\"body\":\"test1\"}");
    //std::string f("{\n    \"id\": \"1\",\n    \"body\": \"test1\"\n}");
    noteJson note;
    note.put(d);
...
{
    BOOST_TEST_MESSAGE("s_noteJson_infromstream_Test");
    std::stringstream d("{\"id\":\"1\",\"body\":\"test1\"}");
    //std::string f("{\n    \"id\": \"1\",\n    \"body\": \"test1\"\n}");
    noteJson note;
    note.inFromStream(d);
...
{
    BOOST_TEST_MESSAGE("s_noteJson_contains_Test");
    std::stringstream d("{\"id\":\"1\",\"body\":\"test1\"}");
    //std::string f("{\n    \"id\": \"1\",\n    \"body\": \"test1\"\n}");
    noteJson note;
    note.inFromStream(d);
...
{
    BOOST_TEST_MESSAGE("s_noetJsonArray_pushback_Test");
    std::stringstream d("{\"id\":\"1\",\"body\":\"test1\"}");
