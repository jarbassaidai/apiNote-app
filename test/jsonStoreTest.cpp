...
BOOST_AUTO_TEST_CASE(s_jsonStore)
{
    setup stuff;
    jsonStore js(stuff.fn);
}

BOOST_AUTO_TEST_CASE(s_jsonStore_getNextId)
{
    setup stuff;
...
BOOST_AUTO_TEST_CASE(s_jsonStore_writeJ)
{
    setup stuff;
    stuff.cleanup = false;
    jsonStore js(stuff.fn);
...
BOOST_AUTO_TEST_CASE(s_jsonStoreIteratorNotEual_Test)
{
    setup stuff;
    //stuff.cleanup = false;
    jsonStore js(stuff.fn);
